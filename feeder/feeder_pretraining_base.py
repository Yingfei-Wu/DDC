...
class Feeder(torch.utils.data.Dataset):
    ...
    def load_data(self, mmap):
        ...
        self.label_path = 'data/NTU-RGB-D-60-AGCN/xsub/train_label.pkl' 
    ...
    def __getitem__(self, index):
        ...
        # label = self.label[index]  #11 label值
        ...
        if self.input_representation == "seq-based" or self.input_representation == "trans-based": 
             ...
             return input_v1, input_v2, input_v3, 0  #self.label[index]  #pretrain时使用

    def basic_aug(self, data_numpy,number_of_frames,p=0.5):
        data_numpy_v2_crop = augmentations.temporal_cropresize(data_numpy,number_of_frames, self.l_ratio, self.input_size)  #0.1 ,1 #随机时间裁剪和插值
...
class Feeder_single(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.data_path = data_path
        self.label_path = label_path  # label_path
        self.num_frame_path = num_frame_path
        self.input_size = input_size
        self.input_representation = input_representation
        self.crop_resize = True
    ...
    def __getitem__(self, index):
        ...
        if self.input_representation == "seq-based" or self.input_representation == "trans-based":
            ...
            data_numpy_v1 = data_numpy_v1.astype('float32')

            return data_numpy_v1, label  # linear_eval
